...
struct mydsp : public dsp {
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider0, FAUSTFLOAT(2e+02f), FAUSTFLOAT(2e+02f), FAUSTFLOAT(5e+02f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = static_cast<FAUSTFLOAT>(0.3f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec1[0]), 65535))]);
			iVec1[1] = iVec1[0];
			fRec1[1] = fRec1[0];
		}
	}
	...
	FAUST_ADDHORIZONTALSLIDER("freq", fHslider0, 2e+02f, 2e+02f, 5e+02f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, freq, "freq", fHslider0, 2e+02f, 2e+02f, 5e+02f, 0.01f) \
